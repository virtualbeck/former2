...
func allCmd() *cobra.Command {
	...
	cmd.Flags().BoolVar(&withImports, "imports", false, "emit workspaces/<env>/imports.tf (import blocks)")
	cmd.Flags().BoolVar(&withImportScript, "import-script", false, "emit workspaces/<env>/import.sh (state-only `tofu import`)")
	return cmd
}
